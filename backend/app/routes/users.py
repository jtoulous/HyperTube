...
async def get_current_user_info(
    ...
    """
    return UserService.get_profile_with_visibility(db, current_user.id, current_user)
...
async def search_user_by_username(
    ...
    return UserService.get_profile_with_visibility(db, user.id, current_user)
...
async def get_user_profile(
    ...
    """
    return UserService.get_profile_with_visibility(db, user_id, current_user)
